...
const infoRows = [
  ...
  { label: "Этажность", value: "До 3-х надземных этажей" },
  { label: "Высота", value: "До 20 метров" },
...
const stepsStart = [
  {
    num: "01",
    icon: "Search",
    title: "Выявление причин отказов",
    desc: "Зоны подтопления, приаэродромной территории, лесного фонда, ошибки в отступах и др. требования",
  },
  {
    num: "02",
    icon: "FileText",
  ...
  },
  {
    ...
    desc: "Орган направляет уведомление о соответствии в течение 7 рабочих дней",
  },
  {
    num: "04",
    icon: "HardHat",
